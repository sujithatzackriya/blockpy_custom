var $builtinmodule = function (name) {
    ...
    var time = function ($gbl, $loc) {
        ...
        $loc.__eq__ = new Sk.builtin.func(function (self, other) {
            ...
            return comparison(function (l, r) {
                return l == r;
            }, self, other);
        });
    ...
    mod.day_compare = new Sk.builtin.func(function (comparison, value, day) {
        ...
        switch (comparison.v) {
            case "IS":
                return Sk.ffi.remapToPy(value_n == day_n);
            case "BEFORE_EQUAL":
                return Sk.ffi.remapToPy(value_n <= day_n);
            case "AFTER_EQUAL":
                return Sk.ffi.remapToPy(value_n >= day_n);
            ...
            case "IS_NOT":
                return Sk.ffi.remapToPy(value_n != day_n);
            default:
                throw new Sk.builtins.ValueError("Unknown comparison");
        }
    });
    ...
    mod.time_compare = new Sk.builtin.func(function (comparison, left, hour, minute, meridian) {
        ...
        switch (comparison.v) {
            case "IS":
                return Sk.ffi.remapToPy(left_time == right_time);
            case "BEFORE_EQUAL":
                return Sk.ffi.remapToPy(left_time <= right_time);
            case "AFTER_EQUAL":
                return Sk.ffi.remapToPy(left_time >= right_time);
