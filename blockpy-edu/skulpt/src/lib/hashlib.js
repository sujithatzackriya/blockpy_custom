...
var $builtinmodule = function (name) {
    ...
    mod.HASH = Sk.misceval.buildClass(mod, HASH, "HASH", []);

    mod.md5 = new Sk.builtin.func(function (value) {
        var hashed = md5(Sk.ffi.remapToJs(value), undefined, true);
        var result = Sk.ffi.remapToPy(hashed);
        return Sk.misceval.callsim(mod.HASH, result);
    });
